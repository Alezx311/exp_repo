...
logger.crit(
  'This critical error has an initial message',
  new Error('this is the stack trace')
);
logger.error(new Error('We have an error'));
logger.error('we have extra metadata', {
  name: 'I am that user',
  stack: new Error('This error also has a stck trace but in the metadata')
    .stack,
});
